...
#define TCXO_PWR_PIN GPIO_NUM_9
#define RF_SWITCH_PIN GPIO_NUM_13

#define RADIO_MOSI GPIO_NUM_30
#define RADIO_MISO GPIO_NUM_19
#define RADIO_SCLK GPIO_NUM_18
#define RADIO_NSS GPIO_NUM_31

#define RADIO_DIO_0 GPIO_NUM_16
#define RADIO_DIO_1 GPIO_NUM_11
